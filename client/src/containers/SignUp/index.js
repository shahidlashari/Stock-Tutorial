      ...
      <Container>
        ...
        <Form>
          <Form.Group controlId="formBasicUsername">
            ...
            <Form.Control type="username" placeholder="Create your username" onChange={(event, newValue) => this.setState({ username: newValue })} />
          </Form.Group>
          <Form.Group controlId="formBasicPassword">
            ...
            <Form.Group controlId="formBasicEmail">
              ...
              <Form.Control type="email" placeholder="Enter email" onChange={(event, newValue) => this.setState({ email: newValue })} />
              <Form.Text className="text-muted">
