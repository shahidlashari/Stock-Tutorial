...
const ReactNavbar = () => {
  ...
  return (
    ...
    <Navbar.Brand href="/home">
      <Image src={LogoImg} width="100" height="50" className="d-inline-block align-top logo" alt="Stock Tutorial Logo" rounded /><h3 className="logo-text">Stock Tutorial</h3>
    </Navbar.Brand>
